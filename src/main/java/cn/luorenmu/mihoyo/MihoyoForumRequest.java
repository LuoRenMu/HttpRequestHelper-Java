...
public class MihoyoForumRequest {
    ...
    private ForumArticle getFourmArticle(String postId) {
        ...
        httpRequest.headerMap(Map.of("DS", StringUtil.getDS(), "x-rpc-client_type", " 2", "x-rpc-app_version", " 2.61.1", "Referer", " https://app.mihoyo.com"), true);
    ...
    private ForumCollectList getCollectionPostList() {
        HttpResponse execute = cn.luorenmu.common.utils.HttpRequest.execute(request.getMihoyo().getForum().getArticleCollect());
